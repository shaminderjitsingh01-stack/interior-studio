...
export const metadata: Metadata = {
  title: 'Contact',
  description: 'Book a consultation with our studio.',
}
  ...
  return (
    <>
      ...
      <section className="pt-40 pb-16 px-6 md:px-12">
        <AnimatedSection>
          <p className="text-xs uppercase tracking-[0.25em] text-warm-stone mb-6">Begin the Conversation</p>
        ...
        <div className="grid md:grid-cols-5 gap-16 md:gap-24">
          <AnimatedSection className="md:col-span-2">
            <div className="space-y-12">
              <div>
                <p className="text-xs uppercase tracking-[0.2em] text-gold mb-4">Studio</p>
              ...
              <div>
                ...
                <p className="text-sm text-mid-gray">hello@yourstudio.com</p>
              ...
              <div>
                <p className="text-xs uppercase tracking-[0.2em] text-gold mb-4">Response Time</p>
